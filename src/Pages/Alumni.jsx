    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-secondary mb-4">ICEM Alumni Network</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Alumni Grid Section - 70% width */}
          <div className="lg:col-span-3">
            <h2 className="text-3xl font-bold text-secondary mb-8 text-center lg:text-left">Our Distinguished Alumni</h2>
                ...
                <div key={alumni.id} className="text-center group">
                  <div className="relative overflow-hidden rounded-lg shadow-lg group-hover:shadow-xl transition-all duration-300 bg-gray-300">
                    <div className="w-full h-48 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-300">
                      <span className="text-gray-600 text-lg font-semibold">Alumni Photo</span>
                    </div>
            ...
            <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-secondary mb-6 text-center">Alumni Network Stats</h3>
            ...
            <div className="mt-12">
              <h2 className="text-3xl font-bold text-secondary mb-8 text-center">Alumni Testimonials</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {testimonials.map((testimonial) => (
                  <div key={testimonial.id} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all duration-300">
          ...
          {/* Registration Form Section - 30% width */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-2xl p-6 sticky top-8">
              <h2 className="text-2xl font-bold text-secondary mb-2">Join Alumni Network</h2>
              <p className="text-gray-600 mb-6 text-sm">Register to stay connected and receive updates</p>
