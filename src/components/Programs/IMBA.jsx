        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 px-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-4 mt-6">
              <button
                onClick={toggleModal}
                className="bg-secondary hover:bg-white hover:text-blacktext-white px-6 py-2 rounded-md transition-colors"
              >
                Apply Now
              </button>
              <button
