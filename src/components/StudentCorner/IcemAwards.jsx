...
import Img1 from "../../assets/img1.png"; // Best Academia Industry Alliance Award
import Img2 from "../../assets/img2.png"; // Innovation & Excellence Awards 2022
import Img3 from "../../assets/img3.png"; // 3i Summit 2018
import Img4 from "../../assets/img4.png"; // Engg & Arch Awards 2017
import Img5 from "../../assets/img5.png"; // 3i Summit 2016
import Img6 from "../../assets/img6.png"; // 3i Summit 2015
  ...
  return (
    <div className="w-full bg-gray-50 text-gray-800">
      ...
      <div className="w-full h-[60vh] relative">
        <img src={Banner} alt="Awards Banner" className="w-full h-full object-cover" />
      ...
      <div className="max-w-7xl mx-auto py-16 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {awards.map((award) => (
            ...
            >
              <img src={award.image} alt={award.title} className="w-full h-56 object-cover" />
              <div className="p-5">
                <h3 className="text-lg font-semibold text-secondary hover:text-primary transition-colors">
                  {award.title}
                </h3>
                <p className="text-sm text-gray-600 mt-2">{award.shortDescription}</p>
                <p className="text-xs text-tertiary mt-3 font-medium">{award.date}</p>
              </div>
            </div>
          ))}
        </div>
