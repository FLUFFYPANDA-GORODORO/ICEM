...
const AwardDetails = () => {
  ...
  const placeholderImg = "https://via.placeholder.com/800x500?text=Award+Image";
  ...
  if (!award) {
    return (
      <div className="w-full h-screen flex flex-col justify-center items-center text-center text-gray-700">
