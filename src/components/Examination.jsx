      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 py-16 px-6">
        ...
        <div className="md:w-2/3 bg-white p-6 rounded-xl shadow-md">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            The Examination Department at Indira College of Engineering and Management (ICEM)
            ensures a fair, transparent, and efficient evaluation process in accordance with
            Savitribai Phule Pune University guidelines. Our examination system is designed
            to assess students' academic performance comprehensively while maintaining
            the highest standards of integrity.
          </p>

          <p className="text-gray-700 leading-relaxed mb-4">
            The department manages all aspects of examinations including scheduling,
            hall ticket issuance, answer sheet evaluation, result declaration, and
            grade card distribution. We follow a systematic approach to ensure timely
            completion of all examination-related processes.
          </p>

          <p className="text-gray-700 leading-relaxed mb-4">
            Students can access their examination schedules, download hall tickets,
            check results, and apply for revaluation through our online portal.
            The examination committee works diligently to address any concerns and
            ensure a smooth examination experience for all students.
          </p>

          <p className="text-gray-700 leading-relaxed mb-4">
            Regular internal assessments, practical examinations, and semester-end
            theory examinations are conducted as per the academic calendar. The
            evaluation process includes both internal and external examiners to
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            it remains relevant and effective in measuring student learning outcomes.
          </p>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-sm">
                        ...
                        <br />
                        <strong>Qualification:</strong> ME Electronics Engineering, First Class. PhD (Pursuing)
                        <br />
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        ...
                        <br />
                        <strong>Qualification:</strong> M.A. Economics, B.Lib, M.Lib
                        <br />
                  ...
                  <table className="w-full border border-gray-300 text-sm">
                    ...
                    <tbody>
                      {[
                        ...
                        ["2", "Dr. Mahesh Kakade, Director, BEE-SPPU, Pune", "Member nominated by Principal, ICEM"],
                        ["3", "Dr. Saurabh Gupta, Dean Academics, ICEM", "Vice – Chairman"],
                        ["4", "Mrs. Pallavi Chavan, Assistant Prof. AI & DS", "Member"],
                        ["5", "Mrs. Ashwini Gaikwad, Assistant Prof. Mechanical", "Member"],
                        ["6", "Dr. Manjusha Tomar, Asso. Prof. FE", "Member"],
                        ["7", "Mrs. Swetkranti Taware, Assistant Prof. Computer", "Member"],
                        ["8", "Dr. Pravin Thorat, Assistant Prof. MBA", "Member"],
                        ["9", "Mrs. Shreya Shennai, Assistant Prof. MCA", "Member"],
                        ["10", "Mr. Sudhir Sawarkar, Assistant Prof. E&TC", "Member"],
                        ["11", "Mrs. Meenakshi Patil, COE, ICEM", "Member Secretary"],
                        ...
                        <tr key={no} className="border">
                          ...
                          <td className="border px-3 py-2 text-center">{designation}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              // 🔹 NEW SECTION 3: TIMETABLE EXAMINATION
              {
                ...
                description: (
                  <ul className="list-disc ml-6 text-sm space-y-2">
                    <li>FY B.Tech 2024 Pattern Vacation Exam Timetable for Apr-May 2025</li>
                    <li>BBA MBA 2024 Pattern 15 Endsem Exam Timetable for Apr-May 2025</li>
                    <li>BCA MCA 2024 Pattern 16 Endsem Exam Timetable for Apr-May 2025</li>
                    <li>FY M.Tech 2024 Pattern Vacation Exam Timetable for Feb 2025</li>
                    <li>FY MCA 2024 Pattern Vacation Exam Timetable for Feb 2025</li>
                    <li>FY Integrated MCA 2024 Pattern Endsem Exam Timetable for Nov-Dec 2024</li>
                    <li>FY MBA 2024 Pattern Endsem Exam Timetable for Nov-Dec 2024</li>
                    <li>FY B.Tech 2024 Pattern Endsem Exam Timetable for Nov-Dec 2024</li>
                  </ul>
                ),
              },
            ].map((item, index) => (
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h4 className="font-semibold text-blue-800 mb-2">Exam Timelines</h4>
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <h4 className="font-semibold text-green-800 mb-2">Important Contacts</h4>
        ...
        <div className="md:w-1/3 bg-[#111] text-white p-6 rounded-xl shadow-md flex flex-col gap-8">
          ...
          <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4 text-sm">
            <h4 className="font-semibold text-yellow-400 mb-2">Upcoming Exams</h4>
          ...
          <div className="bg-secondary/20 border border-secondary/30 rounded-lg p-4 text-sm">
            ...
            <p className="text-gray-300 leading-relaxed">
              For examination-related queries, contact our examination section during office hours.
            </p>
