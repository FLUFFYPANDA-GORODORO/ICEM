...
import ChairpersonImg from "../../assets/chanakya.png"; // replace with actual image
import {
  FaFacebookF,
  FaLinkedinIn,
  FaInstagram,
...
function CFCM() {
  ...
  <div className="flex flex-col md:flex-row gap-8 bg-gray-50 rounded-xl p-6 shadow-md">
    ...
    <div className="md:w-2/3 text-gray-700 leading-relaxed">
      ...
      {/* Awards & Accolades */}
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <h3 className="text-2xl font-bold mb-4">Awards & Accolades</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      {/* Indira Care Club */}
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <h3 className="text-2xl font-bold mb-4">Indira Care Club</h3>
        <p className="italic text-gray-600 mb-3">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        <h3 className="text-2xl font-bold mb-4">Looking Ahead – Team Indira @ 40</h3>
        <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <h3 className="text-2xl font-bold mb-4">On a Personal Front</h3>
        <p className="italic text-gray-600 mb-3">
