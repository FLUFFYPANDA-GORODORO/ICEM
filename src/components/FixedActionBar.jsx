...
const FixedActionBar = () => {
  ...
  return (
    <div className="fixed top-1/2 left-5 -translate-y-1/2 z-[99999] flex items-center">
      {/* Main container */}
      <div
      ...
      >
        ...
        <div className="relative group p-[2px] rounded-md bg-gradient-to-r from-[#00e5ff] via-[#ff00ea] to-[#00e5ff] bg-[length:200%_100%] animate-glow-border transition-all duration-500">
          <button
            title="Menu"
